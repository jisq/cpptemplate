...
my $common_output_path = "/media/data/home/wudi/CPPTemplateExperiment_TOSEM/Results/TemporalFiles/RQ1_analysis/".$proj_name."/";
...
## process freestanding function templates
...
foreach my $func ($db->ents("C Function Template")){
	...
	# only user-defined function templates in C++ files are processed
...
# ===============================================================================================================================================
my $output_path = $common_output_path.$proj_name."-".$version_number."_RQ1_analysis.csv";
if(-e $output_path){
	unlink $output_path;
}
